...
import { ReelsEngineWithStopbehaviors } from '../../reels_engine/reels_engine_with_stop_behaviors';
...
export class ReelsEngineProviderWithStopbehaviors
  implements IReelsEngineProvider, ISlotGameEngineProvider
{
  ...
  constructor(container: Container, useSounds: boolean = true) {
    ...
    this._reelsEngine = new ReelsEngineWithStopbehaviors(
      container,
      new EntitiesEngine(ComponentNames.Count + IconStopbehaviorComponentNames.Count),
      iconsSceneObject,
