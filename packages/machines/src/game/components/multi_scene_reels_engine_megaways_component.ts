...
import { MultiSceneReelsEngineMegaways } from '../../reels_engine/multi_scene_reels_engine_megaways';
...
export class MultiSceneReelsEngineMegawaysComponent
  implements IReelsEngineProvider, ISlotGameEngineProvider
{
  ...
  constructor(
    ...
    this._reelsEngine = new MultiSceneReelsEngineMegaways(
      container,
