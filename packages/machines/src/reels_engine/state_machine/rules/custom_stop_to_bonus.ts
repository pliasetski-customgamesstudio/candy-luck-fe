...
export class CustomStopToBonus<TResponse extends ISpinResponse> extends BaseGameRule<TResponse> {
  ...
  ruleCondition(resp: ResponseHolder<TResponse>): boolean {
    return resp.curResponse.isBonus && !resp.curResponse.isFreeSpins;
  }
}
