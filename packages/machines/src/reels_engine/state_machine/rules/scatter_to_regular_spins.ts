...
export class ScatterToRegularSpins<TResponse extends ISpinResponse> extends ResumeRule<TResponse> {
  ...
  ruleCondition(resp: ResponseHolder<TResponse>): boolean {
    return !resp.curResponse.isBonus && !resp.curResponse.freeSpinsInfo;
  }
}
